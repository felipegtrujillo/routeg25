...
function ReservasFooter() {
  return (
 <div className="flex flex-col justify-start items-center h-[45vh] sm:h-[30vh] w-screen text-white bg-black border-b-0.2 border-gray-400 overflow-hidden">
     ...
     <div className="flex flex-col sm:flex sm:flex-row justify-center items-center h-[60vh] w-full pl-6 md:pl-8 lg:pl-16 gap-6 md:gap-0">
        <div className="flex justify-center sm:justify-start items-center  w-full sm:w-[60vw] xl:w-[80vw]">
            <p className="">  Ven a relajarte a en la naturaleza. ¡Agenda tu estadía en cabañas la calchona hoy y comienza a contar los días!</p>   
        </div>
